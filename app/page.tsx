...
import { RefreshCw, CheckCircle2, Clock, AlertCircle, Leaf, Briefcase, ShoppingCart } from 'lucide-react';
...
export default function Dashboard() {
 ...
 const { workflows, hookItems, activities, calendarEvents, lastUpdated, loading } = data;
 ...
 <Card key={workflow.id} className="border-green-100 mb-3">
