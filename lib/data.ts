// Static data refreshed from memory files - 2/19/2026, 05:00 PM
...
export const activities: ActivityItem[] = [
  { id: 'a1', timestamp: '17:00', action: 'Dashboard refresh complete', actor: 'Hawk', result: '3 workflows, 11 hook items' },
