// Static data refreshed from memory files - 2/24/2026, 09:00 AM
...
export const activities: ActivityItem[] = [
  { id: 'a1', timestamp: '9:00', action: 'Dashboard refresh complete', actor: 'Hawk', result: '3 workflows, 6 hook items' },
