// Static data refreshed from memory files - 3/18/2026, 10:00 AM
...
export const activities: ActivityItem[] = [
  { id: 'a1', timestamp: '10:00', action: 'Dashboard refresh complete', actor: 'Hawk', result: '3 workflows, 0 hook items' },
