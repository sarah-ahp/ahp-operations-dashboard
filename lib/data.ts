// Static data refreshed from memory files - 3/20/2026, 09:01 AM
...
export const activities: ActivityItem[] = [
  { id: 'a1', timestamp: '9:01', action: 'Dashboard refresh complete', actor: 'Hawk', result: '3 workflows, 0 hook items' },
