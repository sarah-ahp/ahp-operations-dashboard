// Static data refreshed from memory files - 3/2/2026, 01:00 PM
...
export const activities: ActivityItem[] = [
  { id: 'a1', timestamp: '13:00', action: 'Dashboard refresh complete', actor: 'Hawk', result: '3 workflows, 0 hook items' },
