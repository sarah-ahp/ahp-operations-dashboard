// Static data refreshed from memory files - 2/19/2026, 08:00 AM
...
export const activities: ActivityItem[] = [
  { id: 'a1', timestamp: '8:00', action: 'Dashboard refresh complete', actor: 'Hawk', result: '3 workflows, 11 hook items' },
