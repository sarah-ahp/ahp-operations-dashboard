// Static data refreshed from memory files - 2/12/2026, 9:31:50 AM
...
export const activities: ActivityItem[] = [
  { id: 'a1', timestamp: '9:31', action: 'Dashboard systematic update', actor: 'Hawk', result: 'Data synced from memory' },
