// Static data refreshed from memory files - 2/16/2026, 5:00:01 PM
...
export const activities: ActivityItem[] = [
  { id: 'a1', timestamp: '17:00', action: 'Dashboard systematic update', actor: 'Hawk', result: 'Data synced from memory' },
