// Static data refreshed from memory files - 3/24/2026, 04:00 PM
...
export const activities: ActivityItem[] = [
  { id: 'a1', timestamp: '16:00', action: 'Dashboard refresh complete', actor: 'Hawk', result: '3 workflows, 0 hook items' },
