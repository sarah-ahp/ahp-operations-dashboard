// Static data refreshed from memory files - 2/12/2026, 3:00:01 PM
...
export const activities: ActivityItem[] = [
  { id: 'a1', timestamp: '15:00', action: 'Dashboard systematic update', actor: 'Hawk', result: 'Data synced from memory' },
