// Static data refreshed from memory files - 3/16/2026, 08:09 AM
...
export const activities: ActivityItem[] = [
  { id: 'a1', timestamp: '8:09', action: 'Dashboard refresh complete', actor: 'Hawk', result: '3 workflows, 0 hook items' },
