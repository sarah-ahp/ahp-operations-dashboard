// Static data refreshed from memory files - 2/19/2026, 12:00 PM
...
export const activities: ActivityItem[] = [
  { id: 'a1', timestamp: '12:00', action: 'Dashboard refresh complete', actor: 'Hawk', result: '3 workflows, 11 hook items' },
