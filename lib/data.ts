// Static data refreshed from memory files - 2/12/2026, 11:00:01 AM
...
export const activities: ActivityItem[] = [
  { id: 'a1', timestamp: '11:00', action: 'Dashboard systematic update', actor: 'Hawk', result: 'Data synced from memory' },
