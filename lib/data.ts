// Static data refreshed from memory files - 2/17/2026, 10:00:05 AM
...
export const activities: ActivityItem[] = [
  { id: 'a1', timestamp: '10:00', action: 'Dashboard systematic update', actor: 'Hawk', result: 'Data synced from memory' },
