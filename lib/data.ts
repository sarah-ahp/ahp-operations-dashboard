// Static data refreshed from memory files - 2/20/2026, 11:00 AM
...
export const activities: ActivityItem[] = [
  { id: 'a1', timestamp: '11:00', action: 'Dashboard refresh complete', actor: 'Hawk', result: '3 workflows, 7 hook items' },
